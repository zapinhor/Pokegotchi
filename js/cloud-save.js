...
export async function cloudSignUp(email,password){return cloudClient.auth.signUp({email,password,options:{emailRedirectTo:'https://pokegotchi.com.br/'}})}
export async function cloudSignIn(email,password){return cloudClient.auth.signInWithPassword({email,password})}
...
export async function cloudResetPassword(email){return cloudClient.auth.resetPasswordForEmail(email,{redirectTo:'https://pokegotchi.com.br/'})}
